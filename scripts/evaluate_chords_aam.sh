#!/bin/bash
#SBATCH --job-name=eval_chords_aam
#SBATCH --partition=Teaching
#SBATCH --gres=gpu:0
#SBATCH --time=02:00:00
#SBATCH --mem=8G
#SBATCH --output=logs/eval_chords_aam_%j.out
#SBATCH --error=logs/eval_chords_aam_%j.err
...
echo "Results saved to /home/s2286943/aam_midi_output/chord_eval_results_aam.json"
